...
const configCache = getLogStores(CacheKeys.SOLID_OIDC_CONFIG || 'solid_oidc_config');

/** Cache for pending auth state (issuer URL, code verifier), keyed by state parameter */
const authStateCache = getLogStores(CacheKeys.SOLID_AUTH_STATE || 'solid_auth_state');
